...
public class GazeboView extends View {
    ...
    public GazeboView() {
        super("You walk over to the Gazebo because you obviously have nothing better n/"
                ...
                + "If you didn't take a Nap (R) it would be a crime.n/"
                + "n/"
                + "Then again you could just go back to the Enchanted Garden and n/"
                + "try to find somehting else to do.n/"
        ...
        switch (input) {
            case 'R':
                System.out.println("You decide to put the dire needs of your nation in the rear view mirror n/"
                        ...
                        + "attacked an eaten by a pack of wild bunnies. That's what you get slacker.n/"
                        + "***********************************GAME OVER**************************************");
                return false;
            case 'N':
                showEnchantedGarden();
